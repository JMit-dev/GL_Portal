...
public:
  ...
  Shader(const char *vertShaderPath, const char *fragShaderPath) {
    ...
    clipLoc = glGetUniformLocation(shaderProgram, "uClipPlane");
  ...
  Shader(const char *vertShaderPath, const char *tescShaderPath,
         const char *teseShaderPath, const char *fragShaderPath) {
    ...
    if (std::ifstream fin{tescShaderPath, std::ifstream::in}) {
      ...
      throw std::runtime_error(
          "tessellation control shader file not successfully read");
    }
    ...
    if (std::ifstream fin{teseShaderPath, std::ifstream::in}) {
      ...
      throw std::runtime_error(
          "tessellation evaluation shader file not successfully read");
    }
  ...
  void setBool(const std::string &name, bool value) const {
    glUniform1i(glGetUniformLocation(shaderProgram, name.c_str()),
  ...
  void setVec2(const std::string &name, const glm::vec2 &value) const {
    glUniform2fv(glGetUniformLocation(shaderProgram, name.c_str()), 1,
                 &value[0]);
  }
  ...
  void setMat2x3(const std::string &name, const glm::mat2x3 &mat) const {
    glUniformMatrix2x3fv(glGetUniformLocation(shaderProgram, name.c_str()), 1,
                         GL_FALSE, &mat[0][0]);
  }
